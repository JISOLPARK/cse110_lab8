describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const shawdowRoot = await prodItems[0].getProperty('shadowRoot');
    const shadowRootButton = await shawdowRoot.$('button');
    ...
    const buttonValue = await buttonInnerText.jsonValue();
  }, 2500);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const cartValue = await cartInnerText.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < prodItems.length; i ++){
      ...
      let buttonValue = await buttonInnerText.jsonValue();
